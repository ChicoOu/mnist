...
public  final class CallableOptions extends
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 50: {
            ...
            feedDevices = input.readMessage(
                FeedDevicesDefaultEntryHolder.defaultEntry.getParserForType(), extensionRegistry);
            feedDevices_.getMutableMap().put(feedDevices.getKey(), feedDevices.getValue());
            break;
          }
          case 58: {
            ...
            com.google.protobuf.MapEntry<java.lang.String, java.lang.String>
            fetchDevices = input.readMessage(
                FetchDevicesDefaultEntryHolder.defaultEntry.getParserForType(), extensionRegistry);
            fetchDevices_.getMutableMap().put(fetchDevices.getKey(), fetchDevices.getValue());
            break;
          }
          case 64: {
   ...
   * </pre>
   *
   * <code>optional .tensorflow.RunOptions run_options = 4;</code>
   */
   ...
   * </pre>
   *
   * <code>optional bool fetch_skip_sync = 8;</code>
   */
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    for (java.util.Map.Entry<java.lang.String, java.lang.String> entry
      ...
      com.google.protobuf.MapEntry<java.lang.String, java.lang.String>
      feedDevices = FeedDevicesDefaultEntryHolder.defaultEntry.newBuilderForType()
          .setKey(entry.getKey())
          .setValue(entry.getValue())
          .build();
      output.writeMessage(6, feedDevices);
    }
    for (java.util.Map.Entry<java.lang.String, java.lang.String> entry
         : internalGetFetchDevices().getMap().entrySet()) {
      com.google.protobuf.MapEntry<java.lang.String, java.lang.String>
      fetchDevices = FetchDevicesDefaultEntryHolder.defaultEntry.newBuilderForType()
          .setKey(entry.getKey())
          .setValue(entry.getValue())
          .build();
      output.writeMessage(7, fetchDevices);
    }
  ...
  public int getSerializedSize() {
    ...
    for (java.util.Map.Entry<java.lang.String, java.lang.String> entry
      ...
      feedDevices = FeedDevicesDefaultEntryHolder.defaultEntry.newBuilderForType()
          ...
          .build();
      size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(6, feedDevices);
    }
    for (java.util.Map.Entry<java.lang.String, java.lang.String> entry
         : internalGetFetchDevices().getMap().entrySet()) {
      com.google.protobuf.MapEntry<java.lang.String, java.lang.String>
      fetchDevices = FetchDevicesDefaultEntryHolder.defaultEntry.newBuilderForType()
          ...
          .build();
      size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(7, fetchDevices);
    }
    if (fetchSkipSync_ != false) {
      size += com.google.protobuf.CodedOutputStream
  ...
  checkByteStringIsUtf8(value);
    ...
    public Builder removeFeedDevices(
        java.lang.String key) {
      if (key == null) { throw new java.lang.NullPointerException(); }
      getMutableFeedDevices().remove(key);
      return this;
    }
    /**
    ...
    public Builder putFeedDevices(
      ...
      getMutableFeedDevices().put(key, value);
      return this;
    }
    /**
     * <pre>
    ...
    public Builder putAllFeedDevices(
      ...
      getMutableFeedDevices().putAll(values);
      return this;
    }
    ...
    public Builder removeFetchDevices(
        java.lang.String key) {
      if (key == null) { throw new java.lang.NullPointerException(); }
      getMutableFetchDevices().remove(key);
      return this;
    }
    /**
     * Use alternate mutation accessors instead.
    ...
    public Builder putFetchDevices(
      ...
      if (key == null) { throw new java.lang.NullPointerException(); }
      if (value == null) { throw new java.lang.NullPointerException(); }
      getMutableFetchDevices().put(key, value);
      return this;
    }
    /**
     * <code>map&lt;string, string&gt; fetch_devices = 7;</code>
    ...
    public Builder putAllFetchDevices(
        java.util.Map<java.lang.String, java.lang.String> values) {
      getMutableFetchDevices().putAll(values);
      return this;
    }
